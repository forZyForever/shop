package com.Nintendo.content.controller;

import com.Nintendo.content.pojo.Content;
import com.Nintendo.content.service.ContentService;
...
public class ContentController {
    ...
    public Result<List<Content>> findCategoryById(@PathVariable(value = "id") long id ){
      List<Content> contents= contentService.findCategoryById(id);
      return new Result<List<Content>>(true,StatusCode.OK,"根据分类id查询广告列表成功",contents);
    }
}
