...
import com.Nintendo.goods.service.SkuService;
...
public class SkuController {
    ...
    public Result findByStatus(@PathVariable(value = "status") String status){
        List<Sku> byStatus = skuService.findByStatus(status);
        return new Result<List<Sku>>(true,StatusCode.OK,"根据审核状态查询成功",byStatus);
    }
