...
import com.Nintendo.order.dao.OrderItemMapper;
import com.Nintendo.order.dao.OrderMapper;
import com.Nintendo.order.pojo.Order;
import com.Nintendo.order.pojo.OrderItem;
import com.Nintendo.order.service.OrderService;
import com.Nintendo.user.feign.UserFeign;
...
public class OrderServiceImpl implements OrderService {
     ...
     */
    @Override
    public void updateStatus(String out_trade_no, String transaction_id,String time_end) {

        Order order = orderMapper.selectByPrimaryKey(out_trade_no);
        try {
            if (null!=order){
                Date date = new SimpleDateFormat("yyyyMMddHHmmss").parse(time_end);
                //对支付日期进行转换
