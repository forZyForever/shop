...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
    ...
    public List<SeckillGoods> list(String time) {
      return   redisTemplate.boundHashOps(Constant.SEC_KILL_GOODS_PREFIX+time).values();
     ...
     */
    @Override
    public SeckillGoods queryOne(String time, Long id) {
        return (SeckillGoods) redisTemplate.boundHashOps(Constant.SEC_KILL_GOODS_PREFIX+time).get(id);
    }
}
